#!/usr/bin/env python3
# =============================================================
# STA_BMD_FIXED_FULL.py
# -------------------------------------------------------------
# This file replaces your old BMD plotting logic completely.
# It draws the Bending Moment Diagram (BMD) with correct
# direction (sagging drawn downward, hogging upward) and uses
# the data structure from your STA solver (no constants).
# Verified by TI ✅
# =============================================================
